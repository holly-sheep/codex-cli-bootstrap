...
| Windows에 WSL2/Ubuntu가 아직 없음 | [Windows PowerShell에서 전체 설치](#windows-powershell) | 이 스크립트가 WSL2와 Ubuntu 준비까지 안내합니다. |
...
처음 설치 중 재부팅하라고 나오거나 Ubuntu 사용자 이름/비밀번호를 만들라고 나오면 정상입니다. 그 과정을 끝낸 뒤 같은 PowerShell 명령을 다시 실행하세요.
