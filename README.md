...
> 전체 개발 환경 설치는 Windows/Ubuntu에 필요한 도구를 설치하므로, 실행 전에 `CODEX_BOOTSTRAP_ALLOW_PACKAGE_INSTALLS=1`을 명시하도록 되어 있습니다. Codex CLI 자체는 수업 기준 버전인 `@openai/codex@0.130.0`으로 고정 설치됩니다.
